...
@section('front-content')
    ...
    <section class="as_contact_wrapper   as_section_light">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                ...
                <div class="as_contact_page_top row">
                    <div class="col-lg-6 col-md-12 col-sm-12">
                        <div class="as_contact_detail as_contact_detail_color ">
                            <ul>
                                <li class="as_info_box">
                                    <span class="as_icon">
                                        <img src="{{ asset('newhome/assets/images/svg/pin.svg') }}" alt="">
                                    </span>
                                    <p>your address goes here</p>
                                </li>
                                <li class="as_info_box">
                                    <span class="as_icon">
                                        <img src="{{ asset('newhome/assets/images/svg/contact.svg') }}" alt="">
                                    </span>
                                    <p>your contact number</p>
                                </li>
                                <li class="as_info_box">
                                    <span class="as_icon">
                                        <img src="{{ asset('newhome/assets/images/svg/message.svg') }}" alt="">
                                    </span>
                                    <p>
                                        <a href="javascript:;">your email goes here</a>
                                    </p>
                                </li>
                            </ul>
                            <div class="as_map">
                                <iframe
                                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d114311.3318193427!2d87.18940460329067!3d26.448342524623403!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39ef744704331cc5%3A0x6d9a85e45c54b3fc!2sBiratnagar%2056613!5e0!3m2!1sen!2snp!4v1689077161191!5m2!1sen!2snp"
                                    width="100%" height="318px" style="border:0;" allowfullscreen="" loading="lazy"
                    ...
                    <div class="col-lg-6 col-md-12">
                        <form class="as_appointment_form">
                            ...
                            <a href="javascript:;" class="as_btn">Send Message</a>
                        </form>
                    </div>
                </div>
            </div>

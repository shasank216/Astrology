    ...
    <li class="nav-item {{ Request::is('admin/doctors*','doctors/doctor-sessions*','admin/doctor-sessions*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-4" aria-current="page"
           href="{{ route('doctors.index') }}">
            ...
            {{-- <span class="aside-menu-title">{{ __('messages.astrologer') }}</span> --}}
            <span class="aside-menu-title">Astrologer</span>
            <span class="d-none">{{ __('messages.astrologer') }}</span>
            <span class="d-none">{{ __('messages.astrologer_sessions') }}</span>
        </a>
    </li>
@endcan
@can('manage_patients')
